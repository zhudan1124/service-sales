    ...
    <div className="clearfix">
      <div className="css-name bg-blue color-white">
        <div className="dhms-container">
          <h1><span className="text-uppercase">dhms</span>
            <small className="color-white">全局 CSS 样式</small>
          </h1>
        </div>
      </div>
        ...
        <div className="content">
          <div className="inner">
            <div className="dhms-css-box">
              ...
              <div className="blank20" />
              <h4>.dhms-fluid
                <small className="color-super-gray"> 用于固定宽度并支持响应式布局的容器。</small>
              </h4>
              <h4>.dhms-container
                <small className="color-super-gray"> 用于 100% 宽度，占据全部视口（viewport）的容器。</small>
              </h4>
              <div className="blank20" />
              ...
              <h4>模拟表格：</h4>
              <div className="row">
                <div className="dhms-xs-24 text-center font18"><strong>设备状态信息报告</strong>
                ...
                <div className="clearfix font14 div-table">
                  ...
                  <div className="div-table-tr">
                    ...
                    <div className="dhms-xs-3"><textarea rows="1" placeholder="请填写设备责任人" />
                    </div>
                    <div className="div-table-tr">
                  ...
                  <div className="blank20" />
                  <h1>.h1 或者 h1
                    <small>font-size: 36px;</small>
                  </h1>
                  <h2>.h2 或者 h2
                    <small>font-size: 30px;</small>
                  </h2>
                  <h3>.h3 或者 h3
                    <small>font-size: 24px;</small>
                  </h3>
                  <h4>.h4 或者 h4
                    <small>font-size: 18px;</small>
                  </h4>
                  <h5>.h5 或者 h5
                    <small>font-size: 14px;</small>
                  </h5>
                  <h6>.h6 或者 h6
                    <small>font-size: 12px;</small>
                  </h6>
                  <div className="blank20" />
                  ...
                  <table className="border table font14">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="text-center">dhms css <span className="color-super-gray">(.text-center 居中)</span>
                        </td>
                      </tr>
                      <tr>
